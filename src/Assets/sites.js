...
const sites = [
    ...
    },
    {
        ...
        description:        "Eyeglasses webstore.",
    ...
    },
    {
        ...
        longDescription:    "Openkitchen is a portfolio project by myself, with the main pitch of its idea being a centralised, crowd-funded meal service. The goal of this project was to showcase the valuable skills and lessons I have learned completing my certification for Full-Stack development. Combining my design experience with the suite of services offered by Google's Firebase platform, I was able to create a fully functional database to manage users and their credentials within this project.",
        involvement:        [
                                "Full website design and development", 
                                "Website built in React.js and hosted on Render", 
                            ],
